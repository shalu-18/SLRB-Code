            ...
            <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
              <form>
                <div style={{ position: "relative", width: "auto" }}>
                  ...
                  <div>
                    <a class="btn " style={{ position: "absolute", right: 0, bottom: 0,background:Btnbgchange, border:'none'}} onClick={() => Navigate('/guestproperty', { state: { id: data._id } })}><img src={download_logo} /></a>
                ...
                <div class="form-group">
                  <p className='my-card-text'>SLRB Verification :<a class="text-success fw-bold"> {data.SLRB_Verfication}</a></p>
                </div>
              </form>
            </div>
          )
...
export default AdminProperties_VERIFIED_Page
